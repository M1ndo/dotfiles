...
(add-hook! '(org-mode-hook markdown-mode-hook text-mode-hook fundamental-mode LaTeX-mode-hook) (lambda () (auto-complete-mode 1)))
...
(map! :leader
      (:prefix-map ("d" . "Doom")
       :desc "Clippy describes function under point" "f" #'eldoc-box-eglot-help-at-point
       :desc "Clippy describes variable under point" "v" #'eldoc-box-help-at-point))
