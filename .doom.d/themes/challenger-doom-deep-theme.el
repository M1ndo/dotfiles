...
(defgroup challenger-doom nil
  "Options for the `challenger-doom-deep' theme."
  :group 'doom-themes)

(defcustom challenger-doom-deep-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'challenger-doom-deep-theme
  :type 'boolean)

(defcustom challenger-doom-deep-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'challenger-doom-deep-theme
  :type 'boolean)

(defcustom challenger-doom-deep-comment-bg challenger-doom-deep-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'challenger-doom-deep-theme
  :type 'boolean)

(defcustom challenger-doom-deep-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme challenger-doom-deep
  ...
  ((bg         '("#12111E" "#121212" nil            ))
   ...
   (base2      '("#3D4551" "#1e2030" "brightblack"  ))
   ...
   (selection      violet)
   (builtin        magenta)
   (comments       (if challenger-doom-deep-brighter-comments dark-blue base4))
   (doc-comments   (if challenger-doom-deep-brighter-comments (doom-darken dark-cyan 0.3) base5) )
   (constants      cyan)
   (functions      magenta)
   (keywords       red)
   (methods        magenta)
   ...
   (-modeline-bright challenger-doom-deep-brighter-modeline)
   (-modeline-pad
    (when challenger-doom-deep-padded-modeline
      (if (integerp challenger-doom-deep-padded-modeline) challenger-doom-deep-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base4)
   ...
   ((font-lock-comment-face &override)
    :background (if challenger-doom-deep-comment-bg (doom-lighten bg 0.05)))
   (mode-line
   ...
   ;; ((org-block &override) :background base1 :foreground comments)
   ;; (org-block :background base1)
   ;; (org-code :background base1)
...
;;; challenger-doom-deep-theme.el ends here
