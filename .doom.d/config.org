...
;; (setq doom-font (font-spec :family "Cascadia Code" :weight 'SemiLight :foreground "#00bfff" :size 15)
...
(setq doom-font (font-spec :family "Iosevka" :weight 'Regular :foreground "#00bfff" :size 15)
      doom-variable-pitch-font (font-spec :family "Cascadia Code" :weight 'SemiBold :size 15)
      doom-big-font (font-spec :family "Cascadia Code" :weight 'SemiBold :size 24))
...
(use-package! doom-themes
  ...
  (load-theme 'doom-horizon t) ;; set laserwave theme
...
(custom-set-variables
 ...
 '(zoom-window-mode-line-color "SlateGrey"))
(zoom-window-setup)
#+end_src
** Editing
*** Aggressive Indent
...
;; (remove-hook! '(org-mode-hook text-mode-hook markdown-mode-hook fundamental-mode) '(lambda () (auto-complete-mode 1)))
...
(map! :leader
      (:prefix-map ("d" . "Doom")
       ...
       :desc "Counel Switch Buffer" "w" #'counsel-switch-buffer
...
(with-eval-after-load 'mu4e
  ...
  (setq mu4e-attachment-dir "~/Downloads/Attachements/")
    ...
    (if (message-mail-p)
        (save-excursion
          (let*
              ...
              (account
                (cond
                ((string-match "REDACTED@gmail.com" from) "Gmail")
                ((string-match "REDACTED@gmail.com" from) "Gmail2"))))
...
#+begin_src emacs-lisp
(setq smudge-oauth2-client-secret "---SECRET---KEY")
(setq smudge-oauth2-client-id "---CLIENT_ID-------")
