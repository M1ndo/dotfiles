  ...
  (let* ((bounds (sem-editmark-bounds))
    ...
    (cond
     ((eq 'latex backend)
      (setf (buffer-substring (car bounds) (cdr bounds))
	    (concat
	     ;;(format "@@latex:\\definecolor{%s}{rgb}{%s,%s,%s}%s{%s}{\\parbox{\\textwidth}{@@"
	     (format "@@latex:\\definecolor{%s}{rgb}{%s,%s,%s}%s{white}{\\eqmakebox{\\bfseries\\color{%s}@@"
