...
" My Theme
hi Normal           guifg=#dfdfdf ctermfg=15   guibg=#282c34 ctermbg=none  cterm=none
hi LineNr           guifg=#5b6268 ctermfg=8    guibg=#282c34 ctermbg=none  cterm=none
hi CursorLineNr     guifg=#202328 ctermfg=7    guifg=#5b6268 ctermbg=8     cterm=none
hi VertSplit        guifg=#1c1f24 ctermfg=0    guifg=#5b6268 ctermbg=8     cterm=none
hi Statement        guifg=#98be65 ctermfg=2    guibg=none    ctermbg=none  cterm=none
hi Directory        guifg=#51afef ctermfg=4    guibg=none    ctermbg=none  cterm=none
hi StatusLine       guifg=#202328 ctermfg=7    guifg=#5b6268 ctermbg=8     cterm=none
hi StatusLineNC     guifg=#202328 ctermfg=7    guifg=#5b6268 ctermbg=8     cterm=none
hi NERDTreeClosable guifg=#98be65 ctermfg=2
hi NERDTreeOpenable guifg=#5b6268 ctermfg=8
hi Comment          guifg=#51afef ctermfg=4    guibg=none    ctermbg=none  cterm=italic
hi Constant         guifg=#3071db ctermfg=12   guibg=none    ctermbg=none  cterm=none
hi Special          guifg=#51afef ctermfg=4    guibg=none    ctermbg=none  cterm=none
hi Identifier       guifg=#5699af ctermfg=6    guibg=none    ctermbg=none  cterm=none
hi PreProc          guifg=#c678dd ctermfg=5    guibg=none    ctermbg=none  cterm=none
hi String           guifg=#3071db ctermfg=12   guibg=none    ctermbg=none  cterm=none
hi Number           guifg=#ff6c6b ctermfg=1    guibg=none    ctermbg=none  cterm=none
hi Function         guifg=#ff6c6b ctermfg=1    guibg=none    ctermbg=none  cterm=none
hi Visual           guifg=#dfdfdf ctermfg=1    guibg=#1c1f24 ctermbg=none  cterm=none
