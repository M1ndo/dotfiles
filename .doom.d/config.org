...
(defun yb/search-folder ()
  (interactive)
  (let ((directory-root '("~/.dotfiles" "~/.config/" "~/Pictures/" "~/Documents/" "~/Downloads/" "~/Templates/" "~/Projects/" "~/Public/" "~/org/" "~/org/roam" "~/Templates/Website/WebRoot/blog_ybenel/" "~/Projects/Git_Pro/")))
